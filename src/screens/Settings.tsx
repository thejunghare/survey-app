...
type SettingsRouteProp = RouteProp<AppStackParamList, "Settings">;
...
const Settings = ({ route }: { route: SettingsRouteProp }) => {
  ...
  return (
    <ScrollView className="flex-1 w-full bg-gray-50">
      ...
      <View className="bg-white border border-slate-200 m-5 rounded-xl">
        <TouchableOpacity className="border-slate-400 flex flex-row items-center justify-between px-3">
